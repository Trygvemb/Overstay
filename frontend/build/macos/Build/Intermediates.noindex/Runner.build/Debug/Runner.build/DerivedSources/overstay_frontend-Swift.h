...
#ifndef OVERSTAY_FRONTEND_SWIFT_H
#define OVERSTAY_FRONTEND_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="overstay_frontend",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17overstay_frontend11AppDelegate")
...
SWIFT_CLASS("_TtC17overstay_frontend17MainFlutterWindow")
